...
|---|---|---|---|
| **Theorem 1.1** (main theorem) | `brualdi_MH` (Ledger) | proved; kernel trace = foundations + the ten cited axioms | I.1 |
...
| **Proposition 4.1** | `boxProd_hamConn_one_bip_walk` (Sec4Walk) | proved **as printed** (walk device); independent absorber alternate (`boxProd_hamConn_one_bip`, Sec4) | II.1, II.5 |
...
| **Lemma 5.7** (interface ≥ 2) | `row_interface_two_of_nonbip` | proved | III.7 |
| **Lemma 5.8** (reachable-terminal richness) | `row_bip_source_reach_two` + `row_bip_source_avoid` | proved **as printed** (since 2026-07-05); the avoid form also carries the independent constructive proof `row_bip_source_avoid_direct` | III.8 |
| **Lemma 5.9** (non-bipartite two-sided avoid) | `row_two_of_nonbip_avoid` | proved | III.9 |
| **Lemma 5.10** (triangle classification) | `triangle_classification`, `wide_row_pair_supports_triangle` | proved (both directions) | III.10 |
| **Lemma 5.11** (buffer existence) | `buffer_line_exists` | proved | III.11 |
| **Lemma 5.12** (buffer quotient non-bipartite) | `rowQuotient_nonbip` (Sec5) | proved **as printed**, including shiftedness (`rowPattern_shifted`, the Gale–Ryser exchange; unit-transfer alternate kept); independent rank-sum alternate (`rowQuotient_nonbip_rankmin`) | III.12, III.13 |
| **Lemma 5.13** (middle-buffer gluing) | `forward_build`/`backward_build`, `row_hinterface_step*`, `pivot_thread_data_of_buffer` | proved | III.14 |
| **Lemma 5.14** (endpoint-buffer gluing) | threading machinery + `pivotBufferData_of_row_line` | proved | III.15 |
| **Proposition 5.15** (single-pass gluing) | `flip_hamConnected_of_row_buffer`, `reduction_pivot` (+ `stageBTransposeIso`) | proved | III.16 |
...
| **Theorem 7.1** (CT products paired 2-DPC) | `canonicalCTProduct_paired_two` (+ `ctProduct_paired_two_of_ranks`: the statement for arbitrary factor orders, via the machine-checked sort isomorphism), `completeTransposition_paired_two`, `ctProduct_consLarge_paired_two`, `CORE'` | proved (the double induction), from A1–A3 | V.2 |
| **Theorem 7.2** (Coleman Thm 1.5) | `coleman_thm15` | **cited** (axiom A1) | — (TRUST_SURFACE A1) |
| **Theorem 7.3** (Coleman Prop 1.1(c)) | `prop11c` | **cited** (axiom A2); hypercube branch = **cited** A3 (Jo–Park–Chwa) | — (TRUST_SURFACE A2, A3) |
...
**Lean:** [`Ledger.lean` lines 943–995](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L943-L995) — trace = foundations + the ten cited axioms (the whole development's surface; `#print axioms brualdi_MH`).
...
**Lean:** [`Ledger.lean` lines 167–213](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L167-L213) — trace: foundations + `weak_ct_product` (A4), `prop11c` (A2), and the Coleman-side axioms through `core_global`.
...
**Lean:** [`Sec4Walk.lean` lines 39–1273](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec4Walk.lean#L39-L1273) — foundations-only.
...
**Lean:** [`AltProofs.lean` lines 88–173](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/AltProofs.lean#L88-L173) — foundations-only.
...
**Lean:** `walk_pick_terminals`, [`Sec4Walk.lean` lines 223–262](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec4Walk.lean#L223-L262), applied inside each shape's boundary pass — foundations-only.
...
**Lean:** [`Sec4.lean` lines 2970–2986](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec4.lean#L2970-L2986) (`boxProd_hamConn_both_nonbip`) and [lines 1193–1213](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec4.lean#L1193-L1213) (`boxProd_prism_card_two`) — foundations-only.
...
**Lean:** `boxProd_hamConn_one_bip`, [`Sec4.lean` lines 3062–3086](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec4.lean#L3062-L3086), with the absorber lemmas at 1446–3060 — foundations-only.
...
**Lean:** [`Ledger.lean` lines 802–848](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L802-L848) — trace: foundations + A2, A4 (through CORE and the laceability bridge).
...
**Lean:** `rowProj` and `rowProj_fibre_iso_patOfSet`, [`Sec5.lean` lines 3355–3469](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L3355-L3469); `fibre_isInterchangeGraph`, [lines 560–612](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L560-L612) — foundations-only.
...
**Lean:** [`Sec5.lean` lines 1392–1596 and 4307–4520](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L1392-L1596/#L4307-L4520) — foundations-only (through `galeRyser_exists`, entry III.2a below).
...
**Lean:** [`GaleRyser.lean` lines 403–479](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/GaleRyser.lean#L403-L479) — **foundations-only** (`propext, Classical.choice, Quot.sound`; no cited axioms).
...
**Lean:** [`Sec5.lean` lines 3956–4302](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L3956-L4302) (the engine) and [4522–4545](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L4522-L4545) (the wrapper) — foundations-only.
...
**Lean:** [`Sec5.lean` lines 927–1372](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L927-L1372) — foundations-only. The paper's printed proof has been this argument since 2026-07-04 (the earlier derived-citation record was judged too thin and replaced).
...
([2169–2204](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L2169-L2204)), whose crossing witness is produced by the same single-switch construction.

## III.5 Corollary 5.5: `rowQuotient_hamConnected`

**Lean:** [`Sec5.lean` lines 2206–2235](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L2206-L2235) — trace: foundations + `naddef_pulleyblank_baseExchange` (A9).
...
**Lean:** [`Sec5.lean` lines 8557–8663](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L8557-L8663) — foundations-only.
...
[7406–7517](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L7406-L7517)): rows `u, v ≠ L` and a third column `c` with
...
## III.7 Lemma 5.7 (interface at least two at a non-bipartite fiber): `row_interface_two_of_nonbip`

**Lean:** [`Sec5.lean` lines 8664–8806](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L8664-L8806) — foundations-only.
...
## III.8 Lemma 5.8 (reachable-terminal richness): `row_bip_source_reach_two`

**Lean:** [`Sec5.lean` lines 8987–9453](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L8987-L9453), on the counting layer at [7744–8362](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L7744-L8362) — trace: foundations + `weak_ct_product` (A4, the balance of constrained fibers, exactly where the paper invokes Proposition 2.2). **As printed since 2026-07-05**; the development's original constructive proof is kept as `row_bip_source_avoid_direct`.
...
The reconstruction now coincides with the paper's printed proof of Lemma 5.8 — the margin
...
## III.9 Lemma 5.9 (non-bipartite two-sided avoid): `row_two_of_nonbip_avoid`

**Lean:** [`Sec5.lean` lines 8363–8556](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L8363-L8556) — foundations-only.
...
## III.10 Lemma 5.10 (triangle classification): `triangle_classification` and `wide_row_pair_supports_triangle`

**Lean:** [`Sec5.lean` lines 4884–5597](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L4884-L5597) — foundations-only.
...
## III.11 Lemma 5.11 (buffer existence): `buffer_line_exists`

**Lean:** [`Sec5.lean` lines 5598–7405](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L5598-L7405) — trace: foundations + `invariantFree_nonbip_has_triangle` (A5, through the triangle source) + `active_prime_cell_varies` (A6) + `prime_class_card_ge` (A7).
...
## III.12 Lemma 5.12, as printed: `rowQuotient_nonbip` by lexicographic compression

**Lean:** [`Sec5.lean` lines 2911–3279](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L2911-L3279) — foundations-only.
...
- Cell variation converts to matroid non-degeneracy: no column is a loop or coloop of the
  ...
  ([1599–1690](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L1599-L1690)) — **as printed since 2026-07-05**: the
...
## III.13 Lemma 5.12, the alternate: `rowQuotient_nonbip_rankmin`

**Lean:** [`Sec5.lean` lines 2405–2910 and 3281–3333](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L3281-L3333) — foundations-only.
...
## III.14 Lemma 5.13 (middle-buffer gluing): the propagation steps and `forward_build`/`backward_build`

**Lean:** [`Sec5.lean` lines 8807–9714 and 10037–10570](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L10037-L10570) — foundations-only (given the packaged inputs).
...
## III.15 Lemma 5.14 (endpoint-buffer gluing): the avoid steps

**Lean:** `PivotBackwardAvoidStep`/`PivotForwardAvoidStep` and
`row_hinterface_step_to_buffer_avoid`, [`Sec5.lean` lines 9718–9843 and 10101–10180](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L9718-L9843) — foundations-only (given the packaged inputs).
...
## III.16 Proposition 5.15 (single-pass gluing) and the §5 capstone: `flip_hamConnected_of_row_buffer`

**Lean:** [`Sec5.lean` lines 10571–11028](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L10571-L11028), consumed by `reduction_pivot` ([`Ledger.lean` 885–912](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L910-L937)) — trace: foundations + A5–A9.
...
- The result is a `PivotThreadData` (entry-exit runs per pattern, chained, disjoint,
  ...
  ([250–290](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec5.lean#L250-L290)) splices the threaded list into the
  Hamilton path.
...
**Lean:** [`Ledger.lean` lines 714–795](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L714-L795), with the two-line Johnson reduction at [464–560](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L464-L560) and the executable certificates in [`Sec6.lean`](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec6.lean) — trace: foundations + `johnson_isMH` (A10), `prime_class_card_ge` (A7), and the CORE-side axioms through the bipartite branch.
...
**Lean:** [`Ledger.lean` lines 103–165](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L103-L165) — trace: foundations + A1–A4.
...
**Lean:** [`Coleman.lean` lines 866–1271](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Coleman.lean#L866-L1271) — trace: foundations + `coleman_thm15` (A1), `prop11c` (A2), `hypercube_ctProduct_paired_two` (A3).
...
(`CTColorIso` through `ctColorIso_insertionSort`, [Coleman 1230–1336](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Coleman.lean#L1230-L1336)), plus
"weakly decreasing rank lists are canonical" (`canonical_of_pairwiseGE`, 1338–1366), give
`ctProduct_paired_two_of_ranks` ([Ledger 129–147](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ledger.lean#L129-L147)) — the paper's silent
...
**Lean:** [`Ryser.lean` lines 143–360](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Ryser.lean#L143-L360) — foundations-only.
...
**Lean:** [`Sec6.lean` lines 290–460 and onward](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Sec6.lean#L290-L460) — foundations-only.
...
**Lean:** [`Coleman.lean` lines 128–470](https://github.com/jbaggett/brualdi-interchange-lean/blob/a6dbe1ebb0e05c7b3ce915899aae65944338d653/BrualdiLean/Coleman.lean#L128-L470) — foundations-only.
